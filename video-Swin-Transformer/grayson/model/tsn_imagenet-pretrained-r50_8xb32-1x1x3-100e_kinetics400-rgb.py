ann_file_train = '/mmaction2/data/custom_train_mp4.txt'
ann_file_val = '/mmaction2/data/custom_val_mp4.txt'
auto_scale_lr = dict(base_batch_size=256, enable=False)
data_root = '/mmaction2/data/train/'
data_root_val = '/mmaction2/data/val/'
...
load_from = '/mmaction2/grayson/work_space/best_acc_top1_epoch_8.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/mmaction2/data/custom_val_mp4.txt',
        data_prefix=dict(video='/mmaction2/data/val/'),
        pipeline=[
...
train_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='/mmaction2/data/custom_train_mp4.txt',
        data_prefix=dict(video='/mmaction2/data/train/'),
        pipeline=[
            dict(io_backend='disk', type='DecordInit'),
            dict(
